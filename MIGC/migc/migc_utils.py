...
from .migc_pipeline import StableDiffusionMIGCPipeline, MIGCProcessor, AttentionStore
...
def offlinePipelineSetupWithSafeTensor(sd_safetensors_path):
    ...
    # Get the root directory (Imagine-and-Seek)
    root_dir = os.path.dirname(project_dir)
    print(root_dir)
    # Use correct paths
    migc_ckpt_path = os.path.join(root_dir, 'weights', 'MIGC_SD14.ckpt')
    # Use HuggingFace model ID for CLIP text encoder (Stable Diffusion 1.5 uses this)
    ...
    # load_migc is already defined in this file, no need to import
