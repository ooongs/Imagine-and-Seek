        ...
        try:
            if self.mode == 'relative':
                ...
                if self.split in ['train', 'val']:
                    ...
                    caption = self.triplets[index]['multi_caption_opt']
                    target_cap = self.triplets[index]['multi_gpt-3.5_opt']
    ...
    def __getitem__(self, index) -> dict:
        try:
            if self.mode == 'relative':
                ...
                reference_name = self.triplets[index]['reference']
                relative_caption = self.triplets[index]['caption']
                multi_opt = self.triplets[index]['multi_caption_opt']
                multi_gpt_opt = self.triplets[index]['multi_gpt-3.5_opt']
